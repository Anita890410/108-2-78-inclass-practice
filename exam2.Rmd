...
pick_econ1 <- stringr::str_detect(courseStructure$`應修系級`,"經濟系1") & enter_year
pick_econ2 <- stringr::str_detect(courseStructure$`應修系級`,"經濟系2") & enter_year
pick_econ3 <- stringr::str_detect(courseStructure$`應修系級`,"經濟系3") & enter_year
pick_econ4 <- stringr::str_detect(courseStructure$`應修系級`,"經濟系4") & enter_year
course1 <- unique(courseStructure$`科目名稱`[pick_econ1])
course2 <- unique(courseStructure$`科目名稱`[pick_econ2])
course3 <- unique(courseStructure$`科目名稱`[pick_econ3])
course4 <- unique(courseStructure$`科目名稱`[pick_econ4])
coursesOffered <- list(course1, course2, course3, course4)
coursesOffered
```
